#!/bin/bash
# Ahmia onion link harvester — fetches fresh .onion URLs from Ahmia.fi
# Feeds into the darkweb crawler queue and seeds file.
# Runs ad-hoc, not in cron.

URL="https://ahmia.fi/static/onion-links.json"
OUT="/opt/darkweb/logs/ahmia_check.log"
SEEDS="/opt/darkweb/seeds.txt"
QUEUE="/opt/darkweb/queue.txt"

mkdir -p /opt/darkweb/logs
